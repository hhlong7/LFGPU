...
// INSTRUCTION DECODER  (RV32I)
// Decodes a 32-bit RV32I instruction into control signals on the DECODE cycle.
//
// decoded_alu_op:
...
//
// decoded_reg_input_mux:  00=ALU  01=mem  10=PC+4 (JAL/JALR link)
//
        ...
        if (reset) begin
            ...
            case (opcode)
                ...
                OP_R: begin
                    ...
                    decoded_reg_input_mux    <= 2'b00;
                    case ({f7b5, funct3})
                        4'b0_000: decoded_alu_op <= 4'd0;  // ADD
                        4'b1_000: decoded_alu_op <= 4'd1;  // SUB
                        4'b0_001: decoded_alu_op <= 4'd2;  // SLL
                        4'b0_010: decoded_alu_op <= 4'd3;  // SLT
                        4'b0_011: decoded_alu_op <= 4'd4;  // SLTU
                        4'b0_100: decoded_alu_op <= 4'd5;  // XOR
                        4'b0_101: decoded_alu_op <= 4'd6;  // SRL
                        4'b1_101: decoded_alu_op <= 4'd7;  // SRA
                        4'b0_110: decoded_alu_op <= 4'd8;  // OR
                        4'b0_111: decoded_alu_op <= 4'd9;  // AND
                        default:  decoded_alu_op <= 4'd0;
                    endcase
                end
                ...
                OP_I_ALU: begin
                    ...
                    case (funct3)
                        3'b000: decoded_alu_op <= 4'd0;              // ADDI
                        3'b001: decoded_alu_op <= 4'd2;              // SLLI  (shamt=imm[4:0])
                        3'b010: decoded_alu_op <= 4'd3;              // SLTI
                        3'b011: decoded_alu_op <= 4'd4;              // SLTIU
                        3'b100: decoded_alu_op <= 4'd5;              // XORI
                        3'b101: decoded_alu_op <= f7b5 ? 4'd7:4'd6; // SRAI:SRLI
                        3'b110: decoded_alu_op <= 4'd8;              // ORI
                        3'b111: decoded_alu_op <= 4'd9;              // ANDI
                        default: decoded_alu_op <= 4'd0;
                    endcase
                end
                ...
                OP_BRANCH: begin
                    ...
                    divergence_event   <= 1;
                    case (funct3)
                        3'b000: decoded_alu_op <= 4'd10; // BEQ
                        3'b001: decoded_alu_op <= 4'd11; // BNE
                        3'b100: decoded_alu_op <= 4'd12; // BLT
                        3'b101: decoded_alu_op <= 4'd13; // BGE
                        3'b110: decoded_alu_op <= 4'd14; // BLTU
                        3'b111: decoded_alu_op <= 4'd15; // BGEU
                        default: decoded_alu_op <= 4'd10;
                    endcase
                end
                ...
                OP_LUI: begin
                    decoded_reg_write_enable <= 1;
                    decoded_alu_src_imm      <= 1;
                    decoded_alu_op           <= 4'd0;  // ADD (x0 + imm_u)
                ...
                OP_AUIPC: begin
                    ...
                    decoded_alu_src_imm      <= 1;
                    decoded_alu_op           <= 4'd0;  // ADD (pc + imm_u)
                    decoded_immediate        <= imm_u;
                    decoded_reg_input_mux    <= 2'b00;
                end

                // ── SYSTEM (EBREAK = thread done) ────────────────────────
                OP_SYSTEM: begin
                    // EBREAK encoding: funct12=001, rs1=x0, funct3=000, rd=x0
                    if (instruction[31:20] == 12'h001)
                        decoded_ret <= 1;
                    // Phase 3: CSR instructions decoded here
                end
