...
module gpu #(
    parameter DATA_MEM_ADDR_BITS = 32,       // 32-bit byte address (RV32I)
    parameter DATA_MEM_DATA_BITS = 32,       // 32-bit data word (RV32I)
    parameter DATA_MEM_NUM_CHANNELS = 4,     // Number of concurrent channels for sending requests to data memory
    parameter PROGRAM_MEM_ADDR_BITS = 32,    // 32-bit PC (RV32I)
    parameter PROGRAM_MEM_DATA_BITS = 32,    // 32-bit instruction (RV32I)
